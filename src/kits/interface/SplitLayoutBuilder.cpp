...
// constructor
BSplitLayoutBuilder::BSplitLayoutBuilder(orientation orientation, float spacing)
    : fView(new BSplitView(orientation, spacing)) {}

// constructor
BSplitLayoutBuilder::BSplitLayoutBuilder(BSplitView *view) : fView(view) {}

// SplitView
BSplitView *BSplitLayoutBuilder::SplitView() const { return fView; }
...
// Add
BSplitLayoutBuilder &BSplitLayoutBuilder::Add(BView *view, float weight) {
...
// Add
BSplitLayoutBuilder &BSplitLayoutBuilder::Add(BLayoutItem *item, float weight) {
...
// SetInsets
BSplitLayoutBuilder &BSplitLayoutBuilder::SetInsets(float left, float top,
...
BSplitLayoutBuilder::operator BSplitView *() { return fView; }
