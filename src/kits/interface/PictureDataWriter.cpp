...
PictureDataWriter::PictureDataWriter() : fData(NULL) {}

PictureDataWriter::PictureDataWriter(BPositionIO *data) : fData(data) {}
...
status_t PictureDataWriter::WriteSetLineMode(const cap_mode &cap,
...
status_t PictureDataWriter::WriteDrawRoundRect(const BRect &rect,
                                               const BPoint &radius,
                                               const bool &fill) {
  try {
...
status_t PictureDataWriter::WriteDrawEllipse(const BRect &rect,
                                             const bool &fill) {
  try {
...
status_t PictureDataWriter::WriteDrawArc(const BPoint &center,
                                         const BPoint &radius,
...
status_t PictureDataWriter::WriteDrawPolygon(const int32 &numPoints,
                                             BPoint *points,
                                             const bool &isClosed,
                                             const bool &fill) {
  try {
...
status_t PictureDataWriter::WriteDrawBezier(const BPoint points[4],
                                            const bool &fill) {
  try {
...
status_t PictureDataWriter::WriteStrokeLine(const BPoint &start,
                                            const BPoint &end) {
  try {
...
status_t PictureDataWriter::WriteDrawShape(const int32 &opCount,
                                           const void *opList,
                                           const int32 &ptCount,
                                           const void *ptList,
                                           const bool &fill) {
...
status_t PictureDataWriter::WriteDrawBitmap(
    const BRect &srcRect, const BRect &dstRect, const int32 &width,
    const int32 &height, const int32 &bytesPerRow, const int32 &colorSpace,
...
status_t PictureDataWriter::WriteDrawPicture(const BPoint &where,
                                             const int32 &token) {
...
status_t PictureDataWriter::WriteClipToShape(int32 opCount, const void *opList,
                                             int32 ptCount, const void *ptList,
                                             bool inverse) {
  try {
