...
// Center
BPoint BGradientConic::Center() const {
...
// Angle
float BGradientConic::Angle() const { return fData.conic.angle; }

// SetAngle
void BGradientConic::SetAngle(float angle) { fData.conic.angle = angle; }
