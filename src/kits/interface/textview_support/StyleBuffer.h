...
inline STEStyleRunDesc *_BStyleRunDescBuffer_::operator[](int32 index) const {
...
inline STEStyleRecord *_BStyleRecordBuffer_::operator[](int32 index) const {
  return &fBuffer[index];
}
...
public:
  StyleBuffer(const BFont *inFont, const rgb_color *inColor);
  ...
  void GetNullStyle(const BFont **font, const rgb_color **color) const;

  void GetStyle(int32 inOffset, BFont *outFont, rgb_color *outColor) const;
  void ContinuousGetStyle(BFont *, uint32 *, rgb_color *, bool *, int32,
                          int32) const;

  STEStyleRange *AllocateStyleRange(const int32 numStyles) const;
  void SetStyleRange(int32 fromOffset, int32 toOffset, int32 textLen,
  ...
  int32 Iterate(int32 fromOffset, int32 length, InlineInput *input,
                const BFont **outFont = NULL, const rgb_color **outColor = NULL,
                float *outAscent = NULL, float *outDescen = NULL,
                uint32 * = NULL) const;
...
inline const _BStyleRunDescBuffer_ &BTextView::StyleBuffer::RunBuffer() const {
