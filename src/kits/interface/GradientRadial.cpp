...
// Center
BPoint BGradientRadial::Center() const {
...
// Radius
float BGradientRadial::Radius() const { return fData.radial.radius; }

// SetRadius
void BGradientRadial::SetRadius(float radius) { fData.radial.radius = radius; }
