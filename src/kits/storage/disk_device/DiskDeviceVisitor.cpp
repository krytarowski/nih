...
/*!	\brief Invoked when a BDiskDevice is visited.
        ...
        If the method returns \c true, the iteration is terminated at this
   point, on \c false continued.
        ...
        \return \c true, if the iteration shall be terminated at this point,
                        \c false otherwise.
*/
bool BDiskDeviceVisitor::Visit(BDiskDevice *device) { return false; }
