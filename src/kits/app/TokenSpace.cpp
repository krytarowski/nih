...
BTokenSpace::BTokenSpace() : BLocker("token space"), fTokenCount(1) {}
...
status_t BTokenSpace::SetHandlerTarget(int32 token,
...
status_t BTokenSpace::AcquireHandlerTarget(int32 token,
