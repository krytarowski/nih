/*
 * Copyright 2004-2005, Axel Dörfler, axeld@pinc-software.de. All rights
...
status_t swap_data(type_code type, void *_data, size_t length,
                   swap_action action) {
// is there anything to do?
  ...
  case B_MESSENGER_TYPE: {
    ...
    while (messenger < end) {
      ...
      messengerPrivate.SetTo(__swap_int32(messengerPrivate.Team()),
