...
BNumberFormat::BNumberFormat() : BFormat() {}

BNumberFormat::BNumberFormat(const BNumberFormat &other) : BFormat(other) {}

BNumberFormat::~BNumberFormat() {}

// #pragma mark - Formatting

ssize_t BNumberFormat::Format(char *string, size_t maxSize,
...
status_t BNumberFormat::Format(BString &string, const double value) const {
  ...
  ObjectDeleter<NumberFormat> numberFormatter(NumberFormat::createInstance(
      *BFormattingConventions::Private(&fConventions).ICULocale(), UNUM_DECIMAL,
      err));
...
ssize_t BNumberFormat::FormatMonetary(char *string, size_t maxSize,
                                      const double value) const {
  BString fullString;
