...
BGridLayoutBuilder::BGridLayoutBuilder(float horizontalSpacing,
    ...
    : fLayout(
          (new BGridView(horizontalSpacing, verticalSpacing))->GridLayout()) {}

// constructor
BGridLayoutBuilder::BGridLayoutBuilder(BGridLayout *layout) : fLayout(layout) {}
...
// GridLayout
BGridLayout *BGridLayoutBuilder::GridLayout() const { return fLayout; }

// View
BView *BGridLayoutBuilder::View() const { return fLayout->Owner(); }
...
// Add
BGridLayoutBuilder &BGridLayoutBuilder::Add(BView *view, int32 column,
                                            int32 row, int32 columnCount,
                                            int32 rowCount) {
...
// Add
BGridLayoutBuilder &BGridLayoutBuilder::Add(BLayoutItem *item, int32 column,
                                            int32 row, int32 columnCount,
                                            int32 rowCount) {
...
// SetRowWeight
BGridLayoutBuilder &BGridLayoutBuilder::SetRowWeight(int32 row, float weight) {
  fLayout->SetRowWeight(row, weight);
  return *this;
}

// SetInsets
BGridLayoutBuilder &BGridLayoutBuilder::SetInsets(float left, float top,
...
BGridLayoutBuilder::operator BGridLayout *() { return fLayout; }
