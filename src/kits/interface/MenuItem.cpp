...
const char *kUTF8ControlMap[] = {
    NULL, "\xe2\x86\xb8", /* B_HOME U+21B8 */
    NULL, NULL, NULL,     /* B_END */
    NULL,                 /* B_INSERT */
    NULL, NULL, NULL,     /* B_BACKSPACE */
    ...
    NULL, NULL, NULL, "\xe2\x86\x90", /* B_LEFT_ARROW */
...
const char *BMenuItem::Label() const { return fLabel; }
...
bool BMenuItem::IsMarked() const { return fMark; }

char BMenuItem::Trigger() const { return fUserTrigger; }
...
BMenu *BMenuItem::Submenu() const { return fSubmenu; }

BMenu *BMenuItem::Menu() const { return fSuper; }

BRect BMenuItem::Frame() const { return fBounds; }
...
void BMenuItem::Draw() {
  ...
  if (activated) {
    ...
    be_control_look->DrawMenuItemBackground(
        fSuper, rect, Frame(), fSuper->LowColor(), BControlLook::B_ACTIVATED);
  } else
...
void BMenuItem::Highlight(bool highlight) { fSuper->Invalidate(Frame()); }

bool BMenuItem::IsSelected() const { return fSelected; }
...
void BMenuItem::_InitMenuData(BMenu *menu) {
  fSubmenu = menu;
...
void BMenuItem::SetAutomaticTrigger(int32 index, uint32 trigger) {
  fTriggerIndex = index;
  fTrigger = trigger;
}
