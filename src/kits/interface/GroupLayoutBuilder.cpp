...
// constructor
BGroupLayoutBuilder::BGroupLayoutBuilder(orientation orientation, float spacing)
...
// RootLayout
BGroupLayout *BGroupLayoutBuilder::RootLayout() const { return fRootLayout; }

// TopLayout
BGroupLayout *BGroupLayoutBuilder::TopLayout() const {
  int32 count = fLayoutStack.CountItems();
  return (count > 0 ? (BGroupLayout *)fLayoutStack.ItemAt(count - 1) : NULL);
}
...
// Add
BGroupLayoutBuilder &BGroupLayoutBuilder::Add(BView *view, float weight) {
  if (BGroupLayout *layout = TopLayout())
...
// Add
BGroupLayoutBuilder &BGroupLayoutBuilder::Add(BLayoutItem *item, float weight) {
  if (BGroupLayout *layout = TopLayout())
...
// AddGlue
BGroupLayoutBuilder &BGroupLayoutBuilder::AddGlue(float weight) {
  if (BGroupLayout *layout = TopLayout())
...
// SetInsets
BGroupLayoutBuilder &BGroupLayoutBuilder::SetInsets(float left, float top,
...
BGroupLayoutBuilder::operator BGroupLayout *() { return fRootLayout; }
