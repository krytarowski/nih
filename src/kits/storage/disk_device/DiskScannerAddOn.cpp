...
/*!	\fn virtual BDiskScannerPartitionAddOn::BDiskScannerParameterEditor *
                CreateEditor(const BSession *session, const char *parameters) =
   0; \brief Creates and returns an editor for editing partitioning parameters
...
/*!	\fn virtual BDiskScannerFSAddOn::BDiskScannerParameterEditor
   *CreateEditor( const BPartition *partition, const char *parameters) = 0;
        \brief Creates and returns an editor for editing initialization
   parameters for a specified partition.
...
/*!	\brief Returns a view containing the controls needed for editing the
        ...
        \return A view containing the controls needed for editing the
   parameters. \c NULL can be returned, if no parameters are needed.
*/
BView *BDiskScannerParameterEditor::View() { return NULL; }
...
/*!	\brief Called when the user finishes editing the parameters.
   ...
   otherwise.
*/
bool BDiskScannerParameterEditor::EditingDone() { return true; }
