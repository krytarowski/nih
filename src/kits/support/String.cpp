...
public:
  PosVect() : fSize(0), fBufferSize(20), fBuffer(NULL) {}

  ~PosVect() { free(fBuffer); }
  ...
  inline int32 ItemAt(int32 index) const { return fBuffer[index]; }
...
inline int32 &BString::_ReferenceCount() {
  return Private::DataRefCount(fPrivateData);
}

inline const int32 &BString::_ReferenceCount() const {
  return Private::DataRefCount(fPrivateData);
}

inline bool BString::_IsShareable() const {
  return fPrivateData != NULL && _ReferenceCount() >= 0;
}

BString::BString() : fPrivateData(NULL) { _Init("", 0); }

BString::BString(const char *string) : fPrivateData(NULL) {
  _Init(string, strlen(safestr(string)));
}

BString::BString(const BString &string) : fPrivateData(NULL) {
...
BString::BString(const char *string, int32 maxLength) : fPrivateData(NULL) {
...
BString &BString::operator=(const BString &string) { return SetTo(string); }
...
BString &BString::operator=(char c) { return SetTo(c, 1); }
...
BString &BString::CopyInto(BString &into, int32 fromOffset,
                           int32 length) const {
  if (this != &into)
...
BString &BString::CopyCharsInto(BString &into, int32 fromCharOffset,
...
bool BString::CopyCharsInto(char *into, int32 *intoLength, int32 fromCharOffset,
                            int32 charCount) const {
  if (into == NULL)
    return false;
...
bool BString::Split(const char *separator, bool noEmptyStrings,
...
BString &BString::InsertChars(const char *string, int32 charCount,
                              int32 charPosition) {
...
BString &BString::InsertChars(const BString &string, int32 charCount,
                              int32 charPosition) {
...
BString &BString::RemoveAll(const char *string) {
...
BString &BString::RemoveSet(const char *setOfBytesToRemove) {
...
BString &BString::MoveInto(BString &into, int32 from, int32 length) {
  if (length) {
...
void BString::MoveInto(char *into, int32 from, int32 length) {
  if (into) {
    CopyInto(into, from, length);
    Remove(from, length);
  }
...
BString &BString::MoveCharsInto(BString &into, int32 fromCharOffset,
                                int32 charCount) {
  if (charCount > 0) {
...
bool BString::MoveCharsInto(char *into, int32 *intoLength, int32 fromCharOffset,
                            int32 charCount) {
...
int BString::Compare(const BString &string, int32 length) const {
  return strncmp(String(), string.String(), length);
}

int BString::Compare(const char *string, int32 length) const {
  return strncmp(String(), safestr(string), length);
}

int BString::CompareAt(size_t offset, const BString &string,
                       int32 length) const {
  return strncmp(String() + offset, string.String(), length);
}

int BString::CompareChars(const BString &string, int32 charCount) const {
  return Compare(string, UTF8CountBytes(fPrivateData, charCount));
}

int BString::CompareChars(const char *string, int32 charCount) const {
  return Compare(string, UTF8CountBytes(fPrivateData, charCount));
}
...
int BString::ICompare(const BString &string, int32 length) const {
  return strncasecmp(String(), string.String(), length);
}

int BString::ICompare(const char *string, int32 length) const {
...
int32 BString::IFindFirst(const BString &string, int32 fromOffset) const {
  if (fromOffset < 0)
    return B_ERROR;
...
BString &BString::ReplaceAll(char replaceThis, char withThis,
                             int32 fromOffset) {
...
BString &BString::Replace(char replaceThis, char withThis,
...
BString &BString::Replace(const char *replaceThis, const char *withThis,
                          int32 maxReplaceCount, int32 fromOffset) {
...
BString &BString::ReplaceAllChars(const char *replaceThis, const char *withThis,
                                  int32 fromCharOffset) {
  return ReplaceAll(replaceThis, withThis,
                    UTF8CountBytes(fPrivateData, fromCharOffset));
}

BString &BString::ReplaceChars(const char *replaceThis, const char *withThis,
...
BString &BString::IReplaceAll(char replaceThis, char withThis,
                              int32 fromOffset) {
  char tmp[2] = {replaceThis, '\0'};
  fromOffset = min_clamp0(fromOffset, Length());
...
BString &BString::IReplace(char replaceThis, char withThis,
                           int32 maxReplaceCount, int32 fromOffset) {
  char tmp[2] = {replaceThis, '\0'};
  fromOffset = min_clamp0(fromOffset, Length());
  int32 pos = _IFindAfter(tmp, fromOffset, 1);
...
BString &BString::IReplaceAll(const char *replaceThis, const char *withThis,
                              int32 fromOffset) {
  if (!replaceThis || !withThis || IFindFirst(replaceThis) < 0)
    return *this;
...
BString &BString::IReplace(const char *replaceThis, const char *withThis,
                           int32 maxReplaceCount, int32 fromOffset) {
  if (!replaceThis || !withThis || maxReplaceCount <= 0 ||
      FindFirst(replaceThis) < 0)
    return *this;
...
BString &BString::ReplaceCharsSet(const char *setOfChars, const char *with) {
  if (!setOfChars || !with)
    return *this;
...
const char *BString::CharAt(int32 charIndex, int32 *bytes) const {
...
bool BString::CharAt(int32 charIndex, char *buffer, int32 *bytes) const {
  int32 length;
...
BString &BString::SetByteAt(int32 pos, char to) {
...
/*!	Detaches this string from an eventually shared fPrivateData, ie. this
   makes this string writable.
*/
...
/*!	Makes this string writable, and resizes the buffer to \a length bytes
   (not including the terminating null).
        ...
        @param copy If true, the current string will be copied into the new
   string.
*/
...
/*!	Allocates a new private data buffer with the space to store \a length
...
int32 BString::_FindAfter(const char *string, int32 offset,
                          int32 length) const {
...
int32 BString::_IFindAfter(const char *string, int32 offset,
                           int32 length) const {
...
int32 BString::_FindBefore(const char *string, int32 offset,
                           int32 length) const {
  if (fPrivateData != NULL) {
...
int32 BString::_IFindBefore(const char *string, int32 offset,
                            int32 length) const {
  if (fPrivateData != NULL) {
...
BString &BString::_DoCharacterEscape(const char *string,
                                     const char *setOfCharsToEscape,
                                     char escapeChar) {
...
BString &BString::_DoReplace(const char *findThis, const char *replaceWith,
                             int32 maxReplaceCount, int32 fromOffset,
                             bool ignoreCase) {
  if (findThis == NULL || maxReplaceCount <= 0 || fromOffset < 0 ||
      fromOffset >= Length())
    return *this;
  ...
  TFindMethod findMethod =
      ignoreCase ? &BString::_IFindAfter : &BString::_FindAfter;
...
extern "C" BStringRef _ZN7BStringixEi(BString *self, int32 index)
