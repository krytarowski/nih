...
public:
  ...
  MyLayoutInfo() : fSize(0) {}

  virtual float ElementLocation(int32 element) { return 0; }

  virtual float ElementSize(int32 element) { return fSize; }
};

// constructor
OneElementLayouter::OneElementLayouter()
    : fMin(-1), fMax(B_SIZE_UNLIMITED), fPreferred(-1) {}

// destructor
OneElementLayouter::~OneElementLayouter() {}

// AddConstraints
void OneElementLayouter::AddConstraints(int32 element, int32 length, float min,
...
// MinSize
float OneElementLayouter::MinSize() { return fMin; }

// MaxSize
float OneElementLayouter::MaxSize() { return fMax; }

// PreferredSize
float OneElementLayouter::PreferredSize() { return fPreferred; }

// CreateLayoutInfo
LayoutInfo *OneElementLayouter::CreateLayoutInfo() { return new MyLayoutInfo; }
...
// CloneLayouter
Layouter *OneElementLayouter::CloneLayouter() {
