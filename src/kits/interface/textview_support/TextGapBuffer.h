...
public:
  ...
  bool InsertText(BFile *file, int32 fileOffset, int32 amount, int32 atIndex);
...
inline int32 TextGapBuffer::Length() const { return fItemCount; }

inline char TextGapBuffer::RealCharAt(int32 index) const {
