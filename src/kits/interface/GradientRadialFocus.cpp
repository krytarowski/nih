...
// Center
BPoint BGradientRadialFocus::Center() const {
...
// Focal
BPoint BGradientRadialFocus::Focal() const {
...
// Radius
float BGradientRadialFocus::Radius() const { return fData.radial_focus.radius; }
