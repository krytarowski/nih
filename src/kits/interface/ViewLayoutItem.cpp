...
BViewLayoutItem::BViewLayoutItem(BView *view)
    : fView(view), fAncestorsVisible(true) {}

BViewLayoutItem::BViewLayoutItem(BMessage *from)
    : BLayoutItem(BUnarchiver::PrepareArchive(from)), fView(NULL),
      fAncestorsVisible(true) {
  BUnarchiver unarchiver(from);
  unarchiver.Finish(unarchiver.FindObject<BView>(
      kViewField, 0, BUnarchiver::B_DONT_ASSUME_OWNERSHIP, fView));
}

BViewLayoutItem::~BViewLayoutItem() {}

BSize BViewLayoutItem::MinSize() { return fView->MinSize(); }

BSize BViewLayoutItem::MaxSize() { return fView->MaxSize(); }

BSize BViewLayoutItem::PreferredSize() { return fView->PreferredSize(); }

BAlignment BViewLayoutItem::Alignment() { return fView->LayoutAlignment(); }
...
BRect BViewLayoutItem::Frame() { return fView->Frame(); }
...
bool BViewLayoutItem::HasHeightForWidth() { return fView->HasHeightForWidth(); }
...
BView *BViewLayoutItem::View() { return fView; }
...
BArchivable *BViewLayoutItem::Instantiate(BMessage *from) {
