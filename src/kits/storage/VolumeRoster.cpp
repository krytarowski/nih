...
BVolumeRoster::BVolumeRoster() : fCookie(0), fTarget(NULL) {}

// Deletes the volume roster and frees all associated resources.
BVolumeRoster::~BVolumeRoster() { StopWatching(); }
...
void BVolumeRoster::Rewind() { fCookie = 0; }
...
status_t BVolumeRoster::StartWatching(BMessenger messenger) {
  StopWatching();
